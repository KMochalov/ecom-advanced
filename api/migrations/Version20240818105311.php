 ...
 */
final class Version20240818105311 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_profiles ALTER name DROP NOT NULL');
        $this->addSql('ALTER TABLE user_profiles ALTER photo DROP NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_profiles ALTER id TYPE UUID');
        $this->addSql('ALTER TABLE user_profiles ALTER user_id TYPE UUID');
        $this->addSql('ALTER TABLE user_profiles ALTER name SET NOT NULL');
        $this->addSql('ALTER TABLE user_profiles ALTER photo SET NOT NULL');
    }
}
